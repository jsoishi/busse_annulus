...
\begin{figure}
    \centering
    \includegraphics[width=0.2\textwidth]{figs/rank_vs_t_run_A_max_knowl_kx_2.pdf}
    \includegraphics[width=0.2\textwidth]{figs/rank_vs_t_run_A_DSS_max_ig_kx_2.pdf}
    \includegraphics[width=0.2\textwidth]{figs/rank_vs_t_run_I_kx_2.pdf}
